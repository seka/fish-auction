    ...
    >
      <Box className={css({ maxW: 'md', w: 'full', spaceY: '8' })}>
        <Box>
          ...
          <Text
            className={css({ mt: '2', textAlign: 'center', fontSize: 'sm', color: 'gray.600' })}
          >
        ...
        <form className={css({ mt: '8', spaceY: '6' })} onSubmit={handleSubmit(onSubmit)}>
          <Box className={css({ rounded: 'md', shadow: 'sm' })}>
            <Stack
              spacing="0"
              className={css({ '& > *': { position: 'relative', _focusWithin: { zIndex: 10 } } })}
            >
              <Box>
                <label htmlFor="name" className={css({ srOnly: true })}>
                  名前
                </label>
                <Input
                  id="name"
              ...
              <Box>
                <label htmlFor="organization" className={css({ srOnly: true })}>
                  所属組織
                </label>
                <Input
                  id="organization"
              ...
              <Box>
                <label htmlFor="contact_info" className={css({ srOnly: true })}>
                  連絡先
                </label>
                <Input
                  id="contact_info"
          ...
          {error && (
            <Box className={css({ color: 'red.500', fontSize: 'sm', textAlign: 'center' })}>
              {error}
            </Box>
          )}

          <Box>
            <Button type="submit" disabled={isSubmitting} className={css({ w: 'full' })}>
