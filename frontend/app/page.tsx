  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href="/admin"
          className={`group ${css({ textDecoration: 'none', display: 'block', h: 'full' })}`}
        >
          <Card
            variant="interactive"
            className={css({
            ...
            >
              ...
              <Box
                className={css({
                  ...
                  _groupHover: { bg: 'primary.600', color: 'white' },
                })}
              >
                <svg
                  className={css({ w: '14', h: '14' })}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              ...
              <Box
                className={css({
                  ...
                  color: 'secondary.600',
                  transition: 'colors 0.3s',
                  _groupHover: { bg: 'secondary.600', color: 'white' },
                })}
              >
                <svg
                  className={css({ w: '14', h: '14' })}
