                ...
                <Box className={css({ md: { gridColumn: '1 / 2' } })}>
                    <Card p="md" className={css({ position: 'sticky', top: '6' })}>
                        <HStack mb="6">
                            ...
                            <Text as="h2" variant="h4" color="green.900" fontWeight="bold">
                                新規中買人登録
                            </Text>
                        </HStack>
                ...
                <Box className={css({ md: { gridColumn: '2 / 3' } })}>
                    <Card padding="none" overflow="hidden">
                        <Box p="6" borderBottom="1px solid" borderColor="gray.200">
                            <Text as="h2" variant="h4" color="gray.800" fontWeight="bold">中買人一覧</Text>
                        </Box>
                        {isLoading ? (
                            <Box p="6" textAlign="center" color="gray.500">読み込み中...</Box>
                        ) : buyers.length === 0 ? (
                            <Box p="6" textAlign="center" color="gray.500">中買人が登録されていません</Box>
                        ) : (
                                ...
                                {buyers.map((buyer) => (
                                    <Box as="li" key={buyer.id} p="6" _hover={{ bg: 'gray.50' }} transition="colors">
                                        <HStack justify="between" align="center">
                                            <Box>
                                                <Text as="h3" fontSize="lg" fontWeight="bold" color="green.900">{buyer.name}</Text>
                                                <Text fontSize="sm" color="gray.500" mt="1">ID: {buyer.id}</Text>
                                            </Box>
                                        </HStack>
                                    </Box>
                                ))}
