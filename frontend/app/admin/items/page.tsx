            ...
            <form onSubmit={actions.onSubmit}>
              <Stack spacing="4">
                <Box>
                  ...
                  <Select {...form.register('auctionId')}>
                ...
                <Box>
                  ...
                  <Select {...form.register('fishermanId')}>
                  ...
                  {form.errors.fishermanId && (
                    <Text className={css({ color: 'red.500' })} fontSize="sm" mt="1">
                      {form.errors.fishermanId.message}
                    </Text>
                  )}
                </Box>
                <Box>
