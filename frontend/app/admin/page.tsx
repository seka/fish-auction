...
export default function AdminDashboard() {
  ...
  const colorStyles: Record<
    string,
    { bg: string; hover: string; iconBg: string; iconText: string }
  > = {
  ...
  return (
    <Box className={css({ maxW: '7xl', mx: 'auto', p: '6' })}>
      <Box className={css({ mb: '8' })}>
        <Text
          variant="h1"
          className={css({ fontSize: '3xl', fontWeight: 'bold', color: 'gray.800' })}
        >
              ...
              >
                <HStack spacing="4" align="start" className={css({ flex: '1' })}>
                  ...
                  <Box className={css({ flex: '1' })}>
                    ...
                    <Text variant="small" className={css({ color: 'gray.600' })}>
                      {item.description}
                    </Text>
                  </Box>
                </HStack>
