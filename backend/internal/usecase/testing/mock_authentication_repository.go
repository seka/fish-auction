...
type MockAuthenticationRepository struct {
	...
	IncrementFailedAttemptsFunc func(ctx context.Context, id int) (int64, error)
...
func (m *MockAuthenticationRepository) IncrementFailedAttempts(ctx context.Context, id int) (int64, error) {
